...
import { createEvent as createEventService, updateEvent as updateEventService } from '@/services/eventService';
...
export default function CreateEventDialog({
  ...
  useEffect(() => {
      ...
      setValue("date", event?.date ? moment(event.date).format("YYYY-MM-DD") : "");
