...
export default function EventPage() {
  ...
  const [isViewEventDetailsDialogOpen, setIsViewEventDetailsDialogOpen] =
    useState<boolean>(false);
  const [isEditEventDialogOpen, setIsCreateEventDialogOpen] =
    useState<boolean>(false);
  const [createEventDialogAction, setCreateEventDialogAction] =
    useState('Create');
  ...
  const handleOpenViewEventDetailsDialog = () =>
    setIsViewEventDetailsDialogOpen(true);

  const handleCloseViewEventDetailsDialog = () =>
    setIsViewEventDetailsDialogOpen(false);
  ...
  return (
    <>
      ...
      <div className="flex justify-center mb-5">
        <Button
          onClick={() => handleOpenCreateEventDialog('Create')}
          variant="gradient"
          color="green"
        >
          Create Event
      ...
      <CreateEventDialog
        ...
        eventAction={createEventDialogAction}
        event={editEvent}
      />
    </>
  );
